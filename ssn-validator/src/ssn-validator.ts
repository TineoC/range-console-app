const validInput = (input: string) => {
	let isValidSSN: boolean = true;
	// 1. Validation

	//	1.1 It should have 9 digits
	const digitsOnSSN: number = input.replace(
		/[^0-9]/g,
		""
	).length;
	if (digitsOnSSN !== 9) {
